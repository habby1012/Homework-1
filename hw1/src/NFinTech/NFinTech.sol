...
contract NFinTech is IERC721 {
    ...
    function setApprovalForAll(address operator, bool approved) external {
        require(operator != address(0), "approve to the zero address");
    ...
    function transferFrom(address from, address to, uint256 tokenId) public {
        ...
        require(msg.sender == from || getApproved(tokenId) == msg.sender || isApprovedForAll(from, msg.sender), "caller is not owner nor approved");
    ...
    function _safeTransfer(address from, address to, uint256 tokenId, bytes memory data) internal {
        ...
        require(_checkOnERC721Received(from, to, tokenId, data), "ERC721Receiver is not implmeneted");
    }
